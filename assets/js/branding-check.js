...
const EXPECTED_COMPANY_WEBSITE = "www.alesphone.com";
const ACCEPTED_COMPANY_WEBSITES = new Set([
  "www.alesphone.com",
  "alesphone.com",
]);
const BRANDING_WARNING =
  "alesphone warning: companyWebsite should not be changed. Changing it may break SIP/WebRTC initialization and related features.";
